-- Ensure a deterministic owner exists for seeded sites/calculations.
INSERT INTO users (id, email, password_hash, full_name, role, active, password_change_required, created_at, updated_at)
SELECT
    '33333333-3333-3333-3333-333333333333',
    'seed.owner@carbon.local',
    '{noop}SeedOwner123!',
    'Seed Owner',
    'ADMIN',
    TRUE,
    ...
    NOW()
WHERE NOT EXISTS (
    SELECT 1 FROM users WHERE id = '33333333-3333-3333-3333-333333333333'
);
...
INSERT INTO sites (
    ...
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', 'Rennes Tech', 'REN-TECH', '15 Rue de la Rennes', 'Rennes', 'France', 3800.00, 85, 145000.00, 'ELECTRICITY_GRID', 150, FALSE, '33333333-3333-3333-3333-333333333333', NOW(), NOW());
...
INSERT INTO calculations (
    ...
    ('cccccccc-cccc-cccc-cccc-ccccccccc003', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', 1, '33333333-3333-3333-3333-333333333333', 145000.00, 'ELECTRICITY_GRID', 0.056000, 97200.000, 8120.000, 105320.000, 27.716842, 702.133333, 'Mock factors inspired by public ADEME Base Carbone references', NOW() - INTERVAL '3 days');
